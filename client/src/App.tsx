...
import { ShieldCheck, ShieldAlert, CheckCircle, XCircle, AlertCircle, RefreshCw, UserCheck } from 'lucide-react';
            ...
            <div className="bg-slate-950 border border-slate-800 rounded-xl p-5 shadow-lg space-y-3">
              <div className="flex items-center justify-between text-xs text-slate-400">
                ...
                <span className="font-semibold text-slate-200">
                  {isSalesRep ? 'Sales Rep (Alex)' : 'Sales Manager (Morgan)'}
                </span>
              </div>
